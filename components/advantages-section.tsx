        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8 gap-6">
            ...
            >
              ...
              <div className="p-6">
                <p className="text-white text-sm text-base/7">
                  УЧАСТНИКИ ПОЛУЧАЮТ ДОХОД СРАЗУ ПОСЛЕ РЕГИСТРАЦИИ: СПРОС
          ...
          >
            ...
            >
              ...
              <div className=" p-6">
                <p className="text-white text-sm  text-base/7">
                  1) МЕТРЫ: РЕАЛЬНЫЕ АКТИВЫ КООПЕРАТИВА В ВИДЕ ДОХОДНОЙ
                  НЕДВИЖИМОСТИ
                  <br />
                  2) ВРЕМЯ ПОЛЬЗОВАНИЯ НЕДВИЖИМОСТЬЮ: НАЧИСЛЯЕТСЯ ДЕРЖАТЕЛЯМ
                  МЕТРОВ И ИМЕЕТ ЭКВИВАЛЕНТ В ВИДЕ ДЕНЕЖНЫХ СРЕДСТВ НА РАСЧЕТНЫХ
                  СЧЕТАХ КООПЕРАТИВА И УПРАВЛЯЮЩЕЙ КОМПАНИИ
                </p>
              </div>
            </motion.div>
          </AnimatedSection>
